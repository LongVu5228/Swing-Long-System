...
- **The database goes well beyond IPOs, and beyond year folders alone**, in the same passage. Each theme is saved across multiple timeframes — "first I have the weekly charts on some of these, and then I have the daily charts, and sometimes I have the intraday charts too, like the 30-minute... I used to use the 30-minute a few years ago, now I use 60 minutes" — and it's actively curated, not just accumulated: "I used to have twice as many charts, but I removed all the illiquid ones that I added when my account was much smaller." Beyond the IPO folders, he names several theme folders with no ticker attached to any single ratio: "non-lethal weapon stocks, the body cam stocks... from 2014, from the Ferguson riots, when those stocks were hot" — flagged himself as lower-quality material, "more like small cap pumps, not institutional quality stocks" — and a crypto-proxy-stocks folder from "late 2017 and January 2018," where he says he "doubled, tripled, quadrupled" his money in a few months, with the reasoning stated directly: "there was no need to trade crypto directly, because the stocks made us big moves and they were much more liquid... a lot of good breakouts there, and also short setups." A separate folder holds parabolic short setups specifically, reaching back to "1999, the [dot-com] brokers — Ameritrade, Schwab, E-Trade." The scale claim: "tens of thousands of charts." Tool-wise, it's Evernote, though he's explicit that the software doesn't matter: "you can use whatever, you don't even have to use a program, you can just build folders on your computer" (t=1:29:37). And asked directly whether he'll share the notes, he declines on principle rather than out of secrecy: "I'm always getting asked, can you share your notes? No, you need to do it — you need to stand on your own two legs" (t=1:26:26).
