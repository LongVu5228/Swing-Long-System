...
A full, named trade with exact entry and result, tracked across four dated sessions. **2020-08-18**, two days before the entry, it's already on his watchlist: "RKT, yeah it's a recent IPO... it's starting to build higher lows. Like new IPOs, you have to trade a bit differently." **2020-08-20**, the entry day: early in the stream, already up and already trimming before he gets to the explanation — "whoa, RKT, this one is gapping up for some reason — I'm gonna sell a little bit of it in pre-market" — then minutes later he walks through the actual setup: "RKT, IPO breakout... it had a big pop-up out of the gate out of the IPO pricing, then it pulled back, started building higher lows, and then took out this range — so I bought it, high 19s." **2020-08-24**, four sessions later, a recap confirming both the mechanics and the result: "I didn't even trade this thing off the daily chart, I traded it on the 60-minute chart — IPOs you trade a bit differently, their base is usually a little bit shorter... 50% in what, one two three four sessions — that's a big move." **2021-03-11**, over six months later, RKT resurfaces as his standing example that a recent IPO doesn't need a five-star setup to pay off — "something like RKT, it was a so-so setup but doubled, almost doubled" (see BMBL, 1.3.24, for the fuller version of that principle).
